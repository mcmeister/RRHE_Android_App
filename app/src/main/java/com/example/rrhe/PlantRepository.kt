...
object PlantRepository {
    ...
    suspend fun getPlantByStockID(stockID: Int): Plant? {
        return plantDao.getPlantByStockID(stockID).firstOrNull()
    }
    ...
    suspend fun getPlantByTempStockID(tempStockID: Int): Plant? {
        return withContext(Dispatchers.IO) {
            plantDao.getPlantByStockID(tempStockID).firstOrNull()
        }
    }
