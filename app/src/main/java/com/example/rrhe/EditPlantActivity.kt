...
class EditPlantActivity : AppCompatActivity(), PhotoManager.PlantBinding, PlantBindingActivity {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.d("DatabasePath", "Database path: " + applicationContext.getDatabasePath("plant-database").absolutePath)
    ...
    fun updateUI(plant: Plant) {
        ...
        PhotoManager.loadImageWithRetry(plant.Photo1, binding.photoEdit1, this)
        PhotoManager.loadImageWithRetry(plant.Photo2, binding.photoEdit2, this)
        PhotoManager.loadImageWithRetry(plant.Photo3, binding.photoEdit3, this)
        PhotoManager.loadImageWithRetry(plant.Photo4, binding.photoEdit4, this)
    }
